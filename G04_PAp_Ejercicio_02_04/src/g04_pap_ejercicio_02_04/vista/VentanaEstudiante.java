 ...
 * @author paulo
 */
public class VentanaEstudiante extends JInternalFrame
{
    ...
    private JScrollPane scroll;
     ...
     public VentanaEstudiante(GestionDato gD) {
        super("Registrar Estudiante",true,true,true,true);
        this.gD=gD;
      ...
      public void iniciaComponentes()
    {
        ...
        this.etiList.add(new JLabel("Colegio"));
